...
<head>
    ...
    <link rel="stylesheet" href="css/genderWomen.css" media="screen">
</head>
<body>
    ...
    <div class="header">
        ...
        <div class="enterHome">
            <div class="miniText">
            <p id="head">WOMEN shoes:</p>
            <p id="underText">Every month a new shoe drop choose your shoes 
            </p>
            </div>
        </div>    
        <img id="menSpecial" src="img/women1.png" alt="">
        <img id="menSpec" src="img/women2.png" alt="">
        <img id="men" src="img/women3.png" alt="">   
        </div>
    </div>
    <div>
        <p class="textMonth">WOMEN'S SHOES THIS MONTH</p>
    </div>
