...
<body>
    ...
    <div class="enterHome">
        <div class="miniText">
        <p id="head">JOIN THE THRIFTSTATION:</p>
        <p id="underText">EVERY MONTH A NEW SHOE DROP</p>
        </div>
        <a href="abbonnementen.html"><button id="journey">Start your journey</button></a>
    </div>
    <img id="img2" src="img/logothrift.png" alt="" height="200px">
    </div>

    <div class="detail1">
        <img class="detailShoe1" src="img/detailschoen1.png" alt="">
        <button id="shoe1">Shop</button>
        <img class="detailShoe2" src="img/detailschoen2.png" alt="">
        <button id="shoe2">Shop</button>
    </div>
    <p class="head-shoe">Men shoes</p>
    ...
    <p class="head-shoe">Women shoes</p>
    <div class="owl-carousel owl-theme">
        <div class="item"><img src="img/schoen1.png"></div>
        <div class="item"><img src="img/schoen2.png"></div>
        <div class="item"><img src="img/schoen3.png"></div>
    ...
    <div class="detail2">
        <img class="detailShoe1" src="img/detailschoen3.png" alt="">
        <button id="shoe1">Shop</button>
        <img class="detailShoe2" src="img/detailschoen4.png" alt="">
        <button id="shoe2">Shop</button>
    </div>

    <p class="head-shoe">kids shoes</p>
    <div class="owl-carousel owl-theme">
        <div class="item"><img src="img/schoen1.png"></div>
        <div class="item"><img src="img/schoen2.png"></div>
        <div class="item"><img src="img/schoen3.png"></div>
