...
<head>
    ...
    <link rel="stylesheet" href="css/genderMen.css" media="screen">
</head>
<body>
    ...
    <div class="header">
        ...
        <div class="enterHome">
            <div class="miniText">
            <p id="head">MENS shoes:</p>
            <p id="underText">Every month a new shoe drop choose your shoes 
            </p>
            </div>
        </div>    
        <img id="menSpecial" src="img/men1.png" alt="">
        <img id="men" src="img/men2.png" alt="">
        <img id="men" src="img/men3.png" alt="">   
        </div>
    </div>
    <div>
        <p class="textMonth">MEN'S SHOES THIS MONTH</p>
    </div>
